...
-- ============================================================
-- VIEW: EMPLOYEES WITH MEMBER INFO
-- ============================================================
...
-- COMENTÁRIOS
-- ============================================================
COMMENT ON TABLE public.employees IS 'Funcionários/colaboradores do ministério. Vinculados a um membro cadastrado.';
COMMENT ON VIEW public.employees_with_member_info IS 'View de funcionários com dados básicos do membro vinculado.';
