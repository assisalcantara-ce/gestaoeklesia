...
export default function AppSidebar({ setIsMobileMenuOpen }: AppSidebarProps) {
  ...
  const filteredGroups = useMemo(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [planFeatures.loading, userCtx.loading, planFeatures.has_modulo_financeiro, planFeatures.has_modulo_financeiro_avancado, planFeatures.has_modulo_eventos, planFeatures.has_modulo_reunioes, planFeatures.has_modulo_agenda, planFeatures.has_modulo_ebd, planFeatures.has_modulo_missoes, userCtx.nivel]);
