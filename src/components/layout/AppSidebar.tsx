...
export default function AppSidebar({ setIsMobileMenuOpen }: AppSidebarProps) {
  ...
  const filterItem = (i: NavigationItem) => {
    ...
    if (i.id === 'funcionarios') {
      if (!planFeatures.has_modulo_funcionarios || !planFeatures.hasFeature('employees_module' as any)) return false;
  ...
  const filteredGroups = useMemo(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [planFeatures.loading, userCtx.loading, planFeatures.has_modulo_financeiro, planFeatures.has_modulo_financeiro_avancado, planFeatures.has_modulo_eventos, planFeatures.has_modulo_reunioes, planFeatures.has_modulo_agenda, planFeatures.has_modulo_ebd, planFeatures.has_modulo_missoes, planFeatures.has_modulo_funcionarios, planFeatures.has_modulo_comissao, planFeatures.has_modulo_kids, planFeatures.has_modulo_presidencial, planFeatures.has_modulo_conselho_fiscal, planFeatures.has_modulo_contabilidade, userCtx.nivel]);
