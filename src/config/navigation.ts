...
export const NAVIGATION_STRUCTURE: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'cartas', label: 'Cartas e Declarações', icon: '📜', path: '/secretaria/cartas', modulo: 'gestao' },
    ...
    items: [
      ...
      },
      {
        ...
        submenu: [
          ...
          { id: 'planejamento-solicitacoes', label: 'Solicitações de Exceção', icon: '📅', path: '/presidencia/planejamento/solicitacoes', modulo: 'presidencia', featureFlag: 'presidency_module', planFeature: 'has_modulo_presidencial' },
        ]
      },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'relatorio-espiritual', label: 'Livro Espiritual', icon: '🕊️', path: '/secretaria/relatorio-espiritual', modulo: 'gestao' },
    ]
  },
  {
    groupName: "ENSINO",
