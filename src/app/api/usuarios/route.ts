...
export async function POST(request: NextRequest) {
  try {
    ...
    if (['secretaria_local', 'auxiliar_secretaria', 'tesouraria_local', 'coordenador_ebd', 'admin_local', 'financeiro_local', 'superintendente', 'coordenador', 'operador'].includes(nivel) && !congregacaoId) {
