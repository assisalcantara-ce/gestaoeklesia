...
export default function PrestacaoContasPage() {
  ...
  if (!planFeatures.has_modulo_contabilidade || !planFeatures.hasFeature('accounting_module')) {
    return (
      <PageLayout title="Prestação de Contas" description="Relatório financeiro mensal automatizado por congregação" activeMenu="prestacao-contas">
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm text-center max-w-2xl mx-auto space-y-5 my-10">
          ...
          <p className="text-slate-500 text-xs leading-relaxed max-w-md mx-auto">
            Faça o upgrade para gerar prestações de contas mensais automatizadas, exportar relatórios contábeis e emitir demonstrativos oficiais por congregação.
          </p>
          <div className="pt-3">
            <a
              href="/configuracoes"
