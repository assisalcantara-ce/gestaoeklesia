          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl max-w-lg w-full p-6 text-gray-100">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-start gap-3 p-3 rounded-lg border border-gray-800 bg-gray-800/20 opacity-50 cursor-not-allowed">
                    <input
                      type="radio"
                      name="modo_liberacao"
                      disabled
                    ...
                    <div>
                      <span className="text-sm font-semibold text-gray-400 block">
                        Ativação com Pagamento ASAAS — 12 meses (Em breve)
                      </span>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-gray-800 text-gray-300 rounded-lg hover:bg-gray-750 transition text-sm font-medium disabled:opacity-50"
              >
                Cancelar
              </button>
              <button
              ...
              >
                {activationLoading ? 'Ativando...' : 'Confirmar Ativação'}
              </button>
            </div>
          </div>
        </div>
