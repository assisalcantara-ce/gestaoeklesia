    ...
    return (
      <MobileShell>
        ...
        <main className="pt-24 px-6 flex flex-col items-center gap-4 text-center flex-1 text-slate-100">
          ...
          <p className="text-slate-300 text-sm">{errorDestino || 'Destino não encontrado.'}</p>
          <button
  ...
  return (
    <MobileShell>
      ...
      <main className="pb-12 px-4 pt-4 space-y-4 flex-1 text-slate-100 max-w-lg mx-auto w-full">
        {/* Card do Destino */}
        <div className="bg-[#111827] rounded-2xl p-5 border border-slate-800 shadow-lg">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-100 leading-tight">{destino.label}</h2>
          ...
          {destino.descricao && (
            <p className="text-xs text-slate-300 mt-2 bg-[#172033] p-3 rounded-xl border border-slate-700/50">
              {destino.descricao}
            </p>
          )}
        </div>
        ...
        {/* Formulário de Valor */}
        <form onSubmit={handleGerarPix} className="bg-[#111827] rounded-2xl p-5 border border-slate-800 shadow-lg space-y-5">
          <div>
            ...
            {hasFixedValue ? (
              <div className="bg-[#172033] p-4 rounded-xl text-center border border-slate-700/60">
                <span className="text-xs text-slate-400 block mb-1 font-medium">Valor fixado pelo ministério</span>
              ...
              <>
                      ...
                      <button
                        ...
                        className={`py-2.5 rounded-xl text-xs font-bold transition-all border ${
                          isSelected
                            ...
                            : 'bg-[#172033] text-slate-300 border-slate-700/50 hover:border-slate-600'
                        }`}
                      >
                        R$ {val}
                      </button>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0,00"
                    className="w-full pl-11 pr-4 py-3.5 bg-[#172033] border border-slate-700/60 rounded-xl text-base font-bold text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
                    required
                  />
                </div>
              </>
          ...
          <div className="pt-2 border-t border-slate-800">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`p-3 rounded-xl border text-left flex flex-col gap-1 transition-all ${
                  !isAnonimo
                    ...
                    : 'border-slate-700/50 bg-[#172033] text-slate-400 hover:border-slate-600'
                }`}
              >
                <div className="flex items-center gap-1.5 font-bold text-xs">
                  <UserCheck size={14} className="text-blue-400" /> Identificada
                </div>
              ...
              >
                <div className="flex items-center gap-1.5 font-bold text-xs">
                  <EyeOff size={14} className="text-blue-400" /> Anônima
                </div>
                <span className="text-[10px] opacity-80 leading-tight">
          ...
          {submitError && (
            <div className="flex items-start gap-2 bg-rose-950/20 text-rose-300 text-xs p-3 rounded-xl border border-rose-500/30">
          ...
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-500 text-white py-4 rounded-xl font-bold text-sm flex items-center justify-center gap-2 active:scale-[0.98] transition disabled:opacity-60 shadow-lg shadow-blue-900/30"
          >
            {isSubmitting ? (
              <>
